...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/itranslate.link/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/itranslate.link/browser'), 'index.html')
    )
    .toString();
  ...
  server.get('*', (req, res) => {
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          title: 'iTranslate.link',
          description:
            'Email or Text a Unique Link and Start Video. Calls that are Translated into any Language!',
          image:
            'https://itranslate.link/assets/images/landingpage/TranslateTube-Banner.jpg',
          site: 'https://www.itranslate.link/',
          url: 'https://www.itranslate.link' + params,
          keywords: 'iTranslate.link',
        };
        if (
          ...
          const talent = {
            name: post?.title || post?.albumname || 'iTranslate.link Post',
            description: pdhtml?.textContent || 'Post content',
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://itranslate.link/assets/images/landingpage/TranslateTube-Banner.jpg',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
          ...
          const talent = {
            name: `iTranslate.link Research ${group?.PageTitle}`,
